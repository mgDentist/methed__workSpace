...
//     "company": "АО НВБС",
//     "description": "У тебя будет возможность погрузиться в мир слаботочных систем, на которых построен Интернет и работают социальные сети, мессенджеры и многое другое.\nТы приобретешь востребованную профессию в сфере IT, наши специалисты обучат тебя с 0 без вложений с твоей стороны.\nМы предлагаем Фиксированную стипендию первые три месяца работы, cвободный график, работу рядом с домом, Оформление по ТК или ИП, ты сам сможешь управлять своим доходом, обеспечим тебя всем необходимым для работы, получишь возможность посмотреть всю Россию, дружный коллектив, развитая корпоративная культура",
//     "email": "info@nvbs.ru",
//     "salary": "86000",
...
const renderModal = (data) => {
    // console.log(data); //посмотреть какие данные выводятся в косоль
...
const init = () => {
    ...
    const cityChoices = new Choices(citySelect, {
        // searchEnable: false, //если оставить, то исчезнет поиск в селекте
        itemSelectText: '',
    });
